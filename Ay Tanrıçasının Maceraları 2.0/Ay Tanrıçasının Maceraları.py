...
devils =  [ "enemy1.png","enemy2.png","enemy3.png","enemy4.png","enemy5.png",
            "enemy1.png","enemy2.png","enemy3.png","enemy4.png","enemy5.png",
            "enemy1.png","enemy2.png","enemy3.png","enemy4.png","enemy5.png",
            "enemy1.png","enemy2.png","enemy3.png","enemy4.png","enemy5.png","moon.png","moon.png","moon.png" ]
...
class Ms(pygame.sprite.Sprite):
    def __init__(self, x=width // 2, y=height // 2):
        super().__init__()
        self.image = pygame.image.load(os.path.join(img_folder,"usagi.png")).convert_alpha()
        self.can = 3
...
class PowerUp(pygame.sprite.Sprite):
    def __init__(self,center):
        ...
        self.image = pygame.transform.scale(pygame.image.load(os.path.join(img_folder,self.choice)),(40,40)).convert_alpha()
        self.rect = self.image.get_rect()
...
class Aliens(pygame.sprite.Sprite):
    def __init__(self):
        ...
        devil = pygame.image.load(os.path.join(img_folder, self.secim)).convert_alpha()
        self.image = devil
        self.rect = self.image.get_rect()
        self.radius = self.rect.width // 2
...
class Animation(pygame.sprite.Sprite):
    def __init__(self,devil,game_folder,list):
        ...
        self.list = list
        self.counter = 1
        self.image = pygame.transform.scale(pygame.image.load(os.path.join(self.game_folder, self.list[self.counter])), self.devil.image.get_size()).convert_alpha()
        self.rect = self.image.get_rect()
...
class Rocket(pygame.sprite.Sprite):
    def __init__(self,msy):
        ...
        self.image = pygame.image.load(os.path.join(img_folder,"fire.png")).convert_alpha()
        self.rect = self.image.get_rect()
...
def hpDraw(screen,x,y,can):
    img = pygame.transform.scale(pygame.image.load(os.path.join(img_folder,"hp1.png")),(25,20)).convert_alpha()
    ...
    if act or aliensNumber == 0:
        ...
        if aliensNumber == 0:
            if counterRestart:
                ...
                levelArticleFont = pygame.font.SysFont("Helvetica", 40)
                article = levelArticleFont.render("LEVEL {}".format(level + 1), 1, (255, 255, 0))

            screen.blit(article, (5, 50))
